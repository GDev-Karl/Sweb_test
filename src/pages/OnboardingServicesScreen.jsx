    ...
    return (
        <div className="min-h-0 bg-white flex flex-col w-full h-screen">
            ...
            <div className="flex flex-row justify-between items-center p-4 sm:px-6 md:px-8 sm:mb-10 md:mb-12">
                ...
                <button
                    className="min-w-0.5 bg-neutral-100 text-gray-900 py-3 px-5 sm:py-4 md:py-5 rounded-4xl text-sm sm:text-base md:text-lg font-semibold hover:shadow-lg transition-all duration-200 active:scale-95 font-dm-sans"
                >
                    Save & exit
                </button>
            </div>
            ...
            {/* Grid Container */}
            <div className="flex-1 items-center pt-3 pb-2">
            ...
            <div className="flex flex-col flex-shrink-0 mb-5 sm:px-6 md:px-8 pb-3 sm:pb-8 md:pb-10">
                
                <div className="relative w-full bg-gray-200 h-2">
                    <div className="bg-gradient-to-r from-orange-400 to-pink-500 h-2" style={{ width: '66%' }}></div>
                </div>
